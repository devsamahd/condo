...
const Customizer: FC = () => {
  ...
  const {setTheme,
    ...
    toggleHorizontal,
    setBorderRadius,
    setCardShadow} = useCustomizer().actions
      ...
      >
        ...
        <Scrollbar sx={{ height: "calc(100vh - 5px)" }}>
          ...
          <Box p={3}>
            ...
            <Stack direction={"row"} gap={2} my={2}>
              <StyledBox
                onClick={() => toggleHorizontal(false)}
                display="flex"
                gap={1}
              >
                <Box
